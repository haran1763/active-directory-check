    ...
    public void service(HttpServletRequest req,HttpServletResponse res) throws IOException,ServletException{
        ...
        try {
            ...
            if(req.getParameter("tname").equals("/sample/Admin/admin.html")){
                ...
                if(DaLoginModule.auth.get(req.getParameter("j_username")).get(0).getName().equals("doctor")){
                ...
                if(DaLoginModule.auth.get(req.getParameter("j_username")).get(0).getName().equals("patient")){
